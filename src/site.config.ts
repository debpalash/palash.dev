...
export const SITE = {
  ...
  description:
    'Palash Debnath (debpalash on GitHub, idebpalash on X) builds VoiceStudio.sh, Bootable, Opal, and memXT — open-source tools for AI audio, media, boot media, and developer memory.',
